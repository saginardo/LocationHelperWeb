                ...
                <ul class="topnav menu-left-nest">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a class="tooltip-tip2 ajax-load" href=${pageContext.request.contextPath}/queryOffLineDevices.action
                                   title="离线设备"><i
                ...
                <%--<ul class="topnav menu-left-nest">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a class="tooltip-tip2 ajax-load" href="../../../pricing_table.html"
                                   title="Pricing Table"><i
...
<div class="wrap-fluid">
    <div class="container-fluid paper-wrap bevel tlbr">
        ...
        <ul id="breadcrumb">
            ...
            <li><a href=${pageContext.request.contextPath }/queryOffLineDevices.action >离线设备</a>
            </li>
            <li class="pull-right">
                <div class="input-group input-widget">
                    <form id="searchForm" action="${pageContext.request.contextPath }/queryDevice.action" method="post">
                        <input name = "deviceId" style="border-radius:15px" type="text" placeholder="搜索设备..." class="form-control">
                    </form>
                </div>
            </li>
        </ul>
